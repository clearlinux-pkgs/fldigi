...
Source0  : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.20.tar.gz
...
%prep
%setup -q -n fldigi-4.1.20
cd %{_builddir}/fldigi-4.1.20
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628174729
...
cp %{_builddir}/fldigi-4.1.20/COPYING %{buildroot}/usr/share/package-licenses/fldigi/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/fldigi-4.1.20/src/mbedtls/LICENSE %{buildroot}/usr/share/package-licenses/fldigi/941df1b3181ce17b8441e0e3775808f266a80fc8
%make_install
%find_lang fldigi
