...
Version  : 4.2.05
Release  : 48
URL      : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.2.05.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.2.05.tar.gz
...
%prep
%setup -q -n fldigi-4.2.05
cd %{_builddir}/fldigi-4.2.05
%patch -P 1 -p1
pushd ..
cp -a fldigi-4.2.05 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713880799
