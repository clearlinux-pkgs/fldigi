...
Source0  : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.25.tar.gz
...
%prep
%setup -q -n fldigi-4.1.25
cd %{_builddir}/fldigi-4.1.25
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676767329
