...
Source0  : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.26.tar.gz
...
%prep
%setup -q -n fldigi-4.1.26
cd %{_builddir}/fldigi-4.1.26
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678888502
