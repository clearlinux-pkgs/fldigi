...
Version  : 4.1.24
Release  : 39
URL      : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.24.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/fldigi/fldigi-4.1.24.tar.gz
...
%prep
%setup -q -n fldigi-4.1.24
cd %{_builddir}/fldigi-4.1.24
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676304873
